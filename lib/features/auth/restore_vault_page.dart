...
class _RestoreVaultPageState extends State<RestoreVaultPage> {
  ...
  Future<void> _performRestore() async {
    ...
    final hasPhrase = phrase.split(' ').length == 24;
    final hasPdf = _selectedBackup != null;
    if (!hasPhrase && !hasPdf) {
      setState(
        () => _errorMessage =
            'Please provide your 24 words OR upload your Recovery PDF.',
      );
      return;
    }
    ...
    //   setState(
    //     () => _errorMessage = 'Please select a .scribevault backup file.',
    //   );
    //   return;
    // }
    ...
    try {
      ...
      // Derive the DEK based on what the user provided
      if (hasPdf) {
        dekBytes = await _crypto.dekFromMnemonic(phrase);
      } else {
        dekBytes = _crypto.dekFromMnemonic(phrase);
      }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Enter your 24-word recovery phrase and select your .scribevault backup file.',
                  style: TextStyle(
                    fontSize: 14,
